...
class FileSystemDownloaderServer:
    ...
    Methods:
        ...
        download_file(channel: queue.Queue, path: str, exit_signal: Event):
            Download a file from a queue channel and save
    ...
    def download_file(
        ...
        """
                Download a file from a queue channel and save it to
                the specified path.

                Args:
                    channel (queue.Queue): A queue containing data chunks
                    to be downloaded.
                ...
                Raises:
                    queue.Empty: If the queue is empty and the exit_signal is
                    not set.

                Note:
                    The download process continues until either the queue is 
                    empty and the exit_signal is not set
