...
class FileSystemLister:
    """
        A class for listing files in a specified directory and sending the list over a network socket.
    """
    ...
    def __init__(self,mount_path: str):
        ...
        Args:
            mount_path (str): The path to the directory whose files will be listed.
        """
        self._mount_path = mount_path

    def list_files(self, channel,socket: RdtSWSocketClient,addr,exit_signal: Event):
        """
        List the files in the specified directory and send the list over a network socket.
        ...
        Args:
            ...
            exit_signal (Event): An event that can be used to signal the exit of the file listing process.
        """
        try:
