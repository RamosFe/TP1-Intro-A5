...
def parse_arguments(command):
    ...
    Returns:
        argparse.Namespace: An object containing the parsed command
        line arguments.
    """
    parser = None
    if command == "upload":
...
def parse_arguments_upload():
    ...
    Returns:
        argparse.ArgumentParser: An ArgumentParser object configured for 
...
def parse_arguments_download():
    ...
    Returns:
        argparse.ArgumentParser: An ArgumentParser object configured 
        for "download" command arguments.
    """
